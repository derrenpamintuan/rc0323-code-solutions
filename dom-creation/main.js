...
function renderPokemon(pokemon) {
  ...
  $pokemonCardText.appendChild($cardName);

  const $cardNumber = document.createElement('h3');
  const $numberText = document.createTextNode(pokemon.number);
  $cardNumber.appendChild($numberText);
  $pokemonCardText.appendChild($cardNumber);

  const $cardText = document.createElement('p');
  const $textText = document.createTextNode(pokemon.description);
  $cardText.appendChild($textText);
  $pokemonCardText.appendChild($cardText);
